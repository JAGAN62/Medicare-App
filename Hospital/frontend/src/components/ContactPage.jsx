...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/8897874514?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              HighTech city, Hyderbad,India.
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 8897874514
            </p>
            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> jagan.mamanduru@gmail.com
            </p>
          </div>
          <iframe
