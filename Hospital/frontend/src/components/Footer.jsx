  ...
  const socialLinks = [
    {
      ...
      name: "Facebook",
      href: "https://www.facebook.com/jagan.mamanduru",
    },
    {
      Icon: Twitter,
      color: footerStyles.twitterColor,
      name: "Twitter",
      href: "https://x.com/JMamanduru16991",
    },
    {
      Icon: Instagram,
      color: footerStyles.instagramColor,
      name: "Instagram",
      href: "https://www.instagram.com/jagan_4321",
    },
    {
      Icon: Linkedin,
      color: footerStyles.linkedinColor,
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/mamanduru-jagan/",
    },
    // {
    //   Icon: Youtube,
      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
          <div className={footerStyles.companySection}>
            ...
            <p className={footerStyles.companyDescription}>
              Your trusted partner is healthcare innovation. We're committed to
              providing exceptional medical care with cuttin-edge technology and
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 8897874514</span>
              </div>
        ...
        <div className={footerStyles.bottomSection}>
          ...
          <div className={footerStyles.designerText}>
            ...
            <a
              href="https://jagan62.github.io/myPortfolio/First/index.html"
              target="_blank"
              className={footerStyles.designerLink}
            >
             Jagan's Medicare Sevices
            </a>
          </div>
        </div>
      </div>
