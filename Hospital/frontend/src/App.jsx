...
import ServiceDeatailPage from "./pages/ServiceDeatailPage";
...
import VerifyServicePayment from "./pages/VerifyServicePayment";
    ...
    <>
      ...
      <div className="overflow-x-hidden bg-white text-gray-900">
        <Routes>
          ...
          <Route path="/services/:id" element={<ServiceDeatailPage />} />
