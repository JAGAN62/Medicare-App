            ...
            <div className={s.searchContainer}>
              <div className={s.searchInputContainer}>
                <input value={query} onChange={(e) => setQuery(e.target.value)} 
                 className={s.searchInput} placeholder='search name / specializtion / fee'/>
...
function MobileDoctorCard ({d}) {
  return (
    <div className={s.mobileDoctorCard}>
      ...
      <div className={s.mobileDoctorFee}>/u20B9 {d.fee}</div>
      </div>
      <div className={s.mobileStatsGrid}>
        ...
        <div>
          ...
          <div className={s.mobileStatValue + " " + s.textSlate600}>{d.appointments.completed}</div>
        </div>
        <div>
